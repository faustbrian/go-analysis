...
One independent complete-diff review is the default for a meaningful Tier C or
Tier D batch. Additional reviews MUST each cover a distinct named high-risk
domain. Fixed review counts and cryptographically bound review records are
